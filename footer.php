  ...
  <div class="rights style-2">
    <div class="container">
      <p>© <?php echo date("Y"); ?> Hospital Management System - Application Developed By <span style="color: white">Shafayet Nur Alam And His team</span></p>
    </div>
  </div>
